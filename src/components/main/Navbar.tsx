...
const Navbar = () => {
    ...
    return (
        <div className="top-0 z-50  h-[65px] w-full bg-[#03001417] px-10 py-2 shadow-lg shadow-[#2A0E61]/50 backdrop-blur-md">
            <div className="m-auto flex h-full w-full flex-row items-center justify-between px-[10px]">
                <Link
                    href="/"
                    className="h-auto  flex-row items-center md:flex"
                >
