...
const SkillText = () => {
    return (
        <div className="flex h-auto w-full flex-col items-center justify-center z-10">
            <motion.div
            ...
            >
                <SparklesIcon className="mr-2 h-5 w-5 dark:text-[#b49bff]  text-purple-800" />
                <h1 className="Welcome-text text-lg  dark:text-[#b49bff]  text-purple-800">Skills And Tools </h1>
            </motion.div>
            <motion.div
                variants={slideInFromLeft(0.5)}
                className="mt-[10px] mb-[15px] text-center font-medium text-[30px]"
            >
                Making apps with modern technologies
            </motion.div>
            <motion.div
                variants={slideInFromRight(0.5)}
                className="cursive mt-2 mb-10 text-center text-2xl  tracking-wider underline underline-offset-4"
            >
